...
object Constants {
    ...
    fun getQuestions():ArrayList<Question>{
        ...
        val sendQuestionList = ArrayList<Question>()
        for(i in 1..10)
        {
            val randomValue: Int = (1..questionsList.size).random()
            sendQuestionList.add(questionsList[randomValue-1])
            questionsList.removeAt(randomValue-1)
        }

        return sendQuestionList
    }
}
